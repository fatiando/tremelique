...
is_dev_version = len(tremelique.__version__.split(".")) > 3
version = "dev" if is_dev_version else tremelique.__version__
...
# Don't build the methods toctree since it's already on the side nav.
...
# html_logo = "_static/tremelique-logo.png"
